        ...
        <div class="main">
            ...
            <table>
                ...
                <tbody>
                    ...
                    $sql = "SELECT prova.*, mateNome  FROM prova INNER JOIN materias ON provaMateria = mateID WHERE provaMateria IN (SELECT mateID FROM materias WHERE mateNome LIKE '%simulado%')";
